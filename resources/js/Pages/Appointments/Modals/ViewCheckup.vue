<template>
    <b-modal v-model="showModal" style="--vz-modal-width: 900px;"  header-class="p-3 bg-light" title="View Checkup Details" class="v-modal-custom" modal-class="zoomIn" centered no-close-on-backdrop>
                    ...
                    <table class="table tablez table-bordered table-nowrap align-middle mb-0 mt-2">
                        <thead class="bg-primary text-white">
                            <tr class="fs-10">
                                ...
                                <th class="text-center" width="25%">Subtype</th>
                        ...
                        <tbody class="bg-white">
                            <tr v-for="(list,index) in selected" v-bind:key="index">
