<template>
<b-modal v-model="showModal" style="--vz-modal-width: 900px;" header-class="p-3 bg-primary-subtle" title="View Schedule" class="v-modal-custom" modal-class="zoomIn" centered no-close-on-backdrop>
